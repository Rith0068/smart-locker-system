...
<body class="bg-[#f5f5f7] min-h-screen flex items-center justify-center p-4 font-sans">
  ...
  <div class="bg-white rounded-2xl border border-gray-200 p-8 w-[440px] max-w-full shadow-sm">
    ...
    <nav class="bg-[#eef0eb] p-1.5 rounded-xl flex mb-6">
      <a href="{{ route('login') }}" class="flex-1 py-2.5 text-center font-bold text-[#2b3a55] text-base bg-white rounded-lg shadow-sm">
        Log in
      </a>
      <a href="{{ route('register') }}" class="flex-1 py-2.5 text-center font-bold text-[#4a5568] text-base rounded-lg hover:text-black transition-colors">
        Create account
      </a>
    </nav>
