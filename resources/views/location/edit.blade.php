...
<div class="w-full px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-6">
        ...
        <h1 class="text-2xl sm:text-3xl font-bold text-gray-800">Edit Location</h1>
        <p class="text-sm text-gray-500 mt-1">Location #{{ $location->id }}</p>
    </div>
    ...
    <form action="{{ route('location.update', $location->id) }}" method="POST" enctype="multipart/form-data"
        ...
        <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <div class="rounded-lg overflow-hidden border border-gray-200 bg-gray-50 h-44">
                    @if ($location->img)
                        <img id="image-preview" src="{{ Storage::url($location->img) }}" alt="{{ $location->name_location }}"
            ...
            <div class="space-y-5">
                <div>
                    ...
                    <input type="text" name="name_location" value="{{ old('name_location', $location->name_location) }}"
                ...
                <div>
                    ...
                    <input type="text" name="adress" value="{{ old('adress', $location->adress) }}"
                           class="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:outline-none">
        ...
        <div class="px-6 py-4 bg-gray-50 border-t border-gray-100 flex justify-end gap-3">
            ...
            <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-lg text-sm font-medium transition-colors">Update Location</button>
        </div>
    </form>
</div>
